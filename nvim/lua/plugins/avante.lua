...
--       max_tokens = 4096,
--       -- api_key_name = "cmd:op item get 'ChatGPT NVIM Key' --reveal --fields credential",
--       api_key_name = { "op", "item", "get", "ChatGPT NVIM Key", "--reveal", "--fields=credential" },
...
--         api_key_name = "",
--         endpoint = "http://100.113.27.25:8080/",
--         model = "DeepSeek-V3-GGUF/DeepSeek-V3-Q2_K_XS/DeepSeek-V3-Q2_K_XS-00001-of-00005.gguf", -- your desired model (or use gpt-4o, etc.)
--         disable_tools = true,
--       },
--     },
--   },
...
--   },
--   keys = {
--     { "<leader>aC", "<cmd>AvanteClear<cr>", desc = "avante: Clear the avante chat session" },
--   },
-- }
